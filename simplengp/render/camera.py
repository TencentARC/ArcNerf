...
from simplengp.geometry.poses import invert_poses
from simplengp.geometry.projection import world_to_pixel, world_to_cam
...
class PerspectiveCamera(object):
    ...
    def get_rays(self, wh_order=True, center_pixel=False):
        """Get camera rays by intrinsic and c2w, in world coord"""
        return get_rays(self.W, self.H, self.get_intrinsic(), self.get_pose(), wh_order, center_pixel)
