...
_dataset_modules = [importlib.import_module(f'simplengp.datasets.{file_name}') for file_name in datasets_filenames]

POTENTIAL_KEYS = ['img', 'mask', 'rays_o', 'rays_d', 'bkg_color']
